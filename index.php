...
<div id="wrapper" class="home-page"> 
	...
	<!-- end slider --> 
		...
		<div class="container">
	 	<div class="row">
			<div class="col-md-12">
				<div class="aligncenter"><h2 class="aligncenter">SheHacks TOP DOCTORS</h2>Our doctors are uniquely selected with reputable profile. They are here to make sure that you get the the best experience and happiness. Your happiness is our concern and they are here to render a unique service like never before.</div>
				<br/>
			</div>
		</div>
            ...
            <div class="col-md-4 col-sm-4 md-margin-bottom-40">
					<div class="card small">
                        ...
                        <div class="card-content">
                            <p>
                                SheHacks is known for its unique and special counceling method for her patient.
                            </p>
                            <p>
